...
Helm是在Kubernetes上安装Falco的首选方法之一。[Falco Helm chart](https://github.com/helm/charts/tree/master/stable/falco)提供了丰富的[可配值](https://github.com/helm/charts/tree/master/stable/falco#configuration)，以使用不同的配置启动Falco。
