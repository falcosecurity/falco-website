...
{{< two_column_block_img img-aligned="right" src="/img/about/instrumenting_system_calls.svg" alt="Instrumenting system calls" index="1 md-1 lg-1 xl-1" header="Instrumenting system calls" >}}
  Observing system calls is performance-critical, and there are two ways in which Falco achieves this: a {{< glossary_tooltip text="modern eBPF probe" term_id="modern-ebpf-probe" >}} or a {{< glossary_tooltip text="kernel module" term_id="kernel-module-driver" >}}.
