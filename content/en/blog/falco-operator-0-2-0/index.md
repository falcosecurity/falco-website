...
kubectl apply --server-side -f https://github.com/falcosecurity/falco-operator/releases/${RELEASE}/download/install.yaml
```
...
```bash
export RELEASE=latest
kubectl apply --server-side -f https://github.com/falcosecurity/falco-operator/releases/${RELEASE}/download/quickstart.yaml
```
