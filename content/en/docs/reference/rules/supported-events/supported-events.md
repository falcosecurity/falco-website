...
Yes | > | **close**(FD fd)
Yes | < | **close**(ERRNO res)
Yes | > | **read**(FD fd, UINT32 size)
Yes | < | **read**(ERRNO res, BYTEBUF data)
Yes | > | **write**(FD fd, UINT32 size)
Yes | < | **write**(ERRNO res, BYTEBUF data)
...
Yes | > | **send**(FD fd, UINT32 size)
Yes | < | **send**(ERRNO res, BYTEBUF data)
Yes | > | **sendto**(FD fd, UINT32 size, SOCKTUPLE tuple)
Yes | < | **sendto**(ERRNO res, BYTEBUF data)
Yes | > | **recv**(FD fd, UINT32 size)
Yes | < | **recv**(ERRNO res, BYTEBUF data)
...
Yes | > | **pread**(FD fd, UINT32 size, UINT64 pos)
Yes | < | **pread**(ERRNO res, BYTEBUF data)
Yes | > | **pwrite**(FD fd, UINT32 size, UINT64 pos)
Yes | < | **pwrite**(ERRNO res, BYTEBUF data)
Yes | > | **readv**(FD fd)
Yes | < | **readv**(ERRNO res, UINT32 size, BYTEBUF data)
Yes | > | **writev**(FD fd, UINT32 size)
Yes | < | **writev**(ERRNO res, BYTEBUF data)
Yes | > | **preadv**(FD fd, UINT64 pos)
Yes | < | **preadv**(ERRNO res, UINT32 size, BYTEBUF data)
Yes | > | **pwritev**(FD fd, UINT32 size, UINT64 pos)
Yes | < | **pwritev**(ERRNO res, BYTEBUF data)
...
Yes | > | **sendfile**(FD out_fd, FD in_fd, UINT64 offset, UINT64 size)
Yes | < | **sendfile**(ERRNO res, UINT64 offset)
