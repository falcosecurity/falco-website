...
`append` | no | When set to `true`, it adds conditions and/or exceptions to a previously defined rule instead of overseeding it. Not used when the goal is just to enable an already existing rule. |
