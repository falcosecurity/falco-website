...
When using the kernel module, the driver will need to be installed and deployed separately as a kernel object, while the modern eBPF probe can be installed directly by libscap.
