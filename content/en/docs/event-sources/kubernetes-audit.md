...
* In versions of Falco between [Falco v0.32.0](/blog/falco-0-32-0.md) and [Falco v0.33.0](/blog/falco-0-33-0.md), Syscalls and K8S Audit event sources cannot be active at the same time due to the restriction of having 1 event source active for each Falco instance. Starting from [version 0.33.0](/blog/falco-0-33-0.md), Falco introduced a standard support for [consuming events from multiple event sources running within the same Falco instance](/docs/event-sources/#configuring-event-sources).
