...
Before reading this page, read the main [plugins](/docs/plugins/) page for an overview of what plugins are and how they are used by Falco/Falco libs.
